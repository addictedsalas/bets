...
let oddsService: OddsService | null = null;
let telegramService: TelegramService | null = null;
let gameMonitor: GameMonitor | null = null;
let betAnalyzer: BetAnalyzer | null = null;
let betTracker: BetTracker | null = null;

// Initialize services only if environment variables are available
if (missingEnvVars.length === 0) {
  try {
    oddsService = new OddsService(process.env.ODDS_API_KEY!);
    ...
    gameMonitor = new GameMonitor(oddsService, telegramService, betAnalyzer, io);
